...
namespace BlueChappie.Controllers
{
    public class LocationsHTMLController : ApiController
    {
        ...
        public string Get(String UserId = "")
        {
            ...
            char kwot = (char)34;
            char crlf = (char)13;
            _retval += "<table style=" + kwot + "width:100%" + kwot + ">";
            foreach (locationWithThumbNails lcn in Locations)
            {
                ...
                if (UserId != null)
                {
                    if (lcn.isFavourite)
                    {
                        _retval += "<td><img src=" + kwot + "images/favRem.png" + kwot + " class=" + kwot + "fav" + kwot + " onclick=" + kwot + "addLocationToFavourite('" + lcn.tKey + "')" + kwot + " id=" + kwot + lcn.tKey + kwot + "  style=" + kwot + "cursor:pointer" + kwot + " /></td>";
                    }
                    else
                    {
                        _retval += "<td><img src=" + kwot + "images/favAdd.png" + kwot + " class=" + kwot + "fav" + kwot + " onclick=" + kwot + "addLocationToFavourite('" + lcn.tKey + "')" + kwot + " id=" + kwot + lcn.tKey + kwot + "  style=" + kwot + "cursor:pointer" + kwot + " /></td>";
                    }

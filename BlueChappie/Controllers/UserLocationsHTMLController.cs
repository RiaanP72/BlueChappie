...
{
    public class UserLocationsHTMLController : ApiController
    {

        // GET: api/UserLocationsHTML/5
        ...
        // POST: api/UserLocationsHTML
        public void Post([FromBody]string value)
        {
        }

        // PUT: api/UserLocationsHTML/5
        public void Put(int id, [FromBody]string value)
        {
        }

        // DELETE: api/UserLocationsHTML/5
